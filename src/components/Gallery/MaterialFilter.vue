  ...
  <div class="search-filter-form __zw-search-filter-form">
    ...
    <div class="search-field scroll-bar" style="max-width:800px;max-height:500px;overflow-y:auto">
      ...
      <div class="form-item">
        ...
        <div class="cont flex">
          <CheckBox :data="filterData.elementData" v-model="form.material_category" :isMultiple="true" :is-fold="true" :fold-number="4"></CheckBox>
        </div>
      </div>
      <div class="form-item">
        <div class="label">
...
export default {
  ...
  watch: {
    config: {
      handler(val) {
        let {productTypeCategoryMap, materialCategoryMap, designStyleMap} = val;
        this.filterData.cgData = productTypeCategoryMap;
        this.filterData.elementData = materialCategoryMap;
